...
export default function ClientForm() {
  ...
  const [hireLawyer, setHireLawyer] = useState(null); // Will hold true/false instead of yes/no
  const [hireTime, setHireTime] = useState("");
  const [contactMethod, setContactMethod] = useState(null); // Will now hold "call", "message", or "none"
